...
(function($) {
    ...
    methods = {
        ...
        _getBoundaries: function(opts) {
            ...
            if (mostN == -1000) methods._boundaries = {
                N: 0,
                E: 0,
                W: 0,
                S: 0
        ...
        addMarker: function(marker) {
            ...
            if (opts.log) {
                console.log('putting marker at ' + marker.latitude + ', ' + marker.longitude + ' with address ' + marker.address + ' and html ' + marker.html);
            }
        ...
        getRoute: function(options) {
            ...
            var $data = this.data('gmap'),
                ...
                $travelUnits = {
                    'MILES': $googlemaps.DirectionsUnitSystem.IMPERIAL,
                    'KM': $googlemaps.DirectionsUnitSystem.METRIC
                },
                displayObj = null,
                travelMode = null,
                travelUnit = null,
    ...
    $.fn.gMap.defaults = {
        ...
        controls: {},
        scrollwheel: true,
        maptype: (typeof(google) != "undefined") ? google.maps.MapTypeId.ROADMAP : null,
        ...
        controlsStyle: {
            mapType: (typeof(google) != "undefined") ? google.maps.MapTypeControlStyle.DEFAULT : null,
            zoom: (typeof(google) != "undefined") ? google.maps.ZoomControlStyle.DEFAULT : null
        },
