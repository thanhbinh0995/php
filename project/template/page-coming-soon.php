...
<!-- Mirrored from htmlcoder.me/preview/the_project/v.1.1/template/page-coming-soon.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Nov 2015 07:41:56 GMT -->
<head>
		<meta charset="utf-8">
		<title>The Project | Page Coming Soon</title>
		...
		<div class="page-wrapper">
			...
			<div class="pv-40 dark-translucent-bg">
				<div class="container">
						...
						<div class="col-md-8 text-center col-md-offset-2 pv-20">
							<div class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">
								...
								<div id="logo" class="logo text-center">
									<h3 class="margin-clear"><a href="index.php" class="logo-font link-light">The <span class="text-default">Project</span></a></h3>
								</div>
								<!-- name-and-slogan -->
								<p class="small">Multipurpose HTML5 Template</p>
								<h1 class="page-title text-center">Coming Soon</h1>
								<div class="separator"></div>
								<p class="text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure perspiciatis quod, voluptatum, porro pariatur facere id in unde obcaecati nobis sapiente cupiditate ipsa veniam quam natus voluptate ipsum minima soluta!</p>
					...
					<!-- .subfooter start -->
					<!-- ================ -->
					<p class="text-center object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">Copyright © 2015 The Project by <a target="_blank" href="http://htmlcoder.me/">HtmlCoder</a>. All Rights Reserved</p>
					<!-- .subfooter end -->
				</div>
			</div>
			<!-- banner end -->
