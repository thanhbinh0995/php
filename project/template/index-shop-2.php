...
<!-- Mirrored from htmlcoder.me/preview/the_project/v.1.1/template/index-shop-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Nov 2015 07:35:22 GMT -->
<head>
		<meta charset="utf-8">
												...
												<ul class="nav navbar-nav ">
																		...
																		<div class="row">
																			<div class="col-sm-4">
																				...
																				<ul class="menu">
																					...
																					<li class="active"><a href="index-shop-2.php"><i class="icon-basket-1 pr-10"></i>Commerce 2</a></li>
																				</ul>
																			</div>
																			<div class="col-sm-4">
																				<div class="divider"></div>
													...
													<li class="dropdown active">
														...
														<ul class="dropdown-menu">
															...
															<li class="active"><a href="index-shop-2.php">Shop Home 2</a></li>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="footer-content">
										...
										<nav class="mb-20">
											<ul class="nav nav-pills nav-stacked list-style-icons">
												<li><a href="components-social-icons.php"><i class="icon-tools"></i> Settings</a></li>
												<li><a href="components-buttons.php"><i class="icon-search"></i> My Orders</a></li>
												<li><a href="components-buttons.php"><i class="icon-basket-1"></i> Cart</a></li>
												<li><a href="components-forms.php"><i class="icon-heart"></i> Wish List</a></li>
												<li><a href="components-tabs-and-pills.php"><i class="icon-chat"></i> Notifications</a></li>
