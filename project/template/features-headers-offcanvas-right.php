...
<!-- Mirrored from htmlcoder.me/preview/the_project/v.1.1/template/features-headers-offcanvas-right.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Nov 2015 07:47:36 GMT -->
<head>
		<meta charset="utf-8">
		<title>The Project | Offcanvas Header Right</title>
		...
		<div class="page-wrapper">
			...
			<div class="offcanvas-container">
				<nav id="offcanvas" class="animated navmenu navmenu-default navmenu-fixed-right offcanvas offcanvas-right" role="navigation">
					<!-- logo -->
					<div class="logo">
						<a href="index.php"><img id="logo" src="images/logo_light_blue.png" alt="The Project"></a>
					</div>
					...
					<ul class="nav navbar-nav text-center">
						...
						<li><a href="shop-listing-3col.php">Shop</a></li>
